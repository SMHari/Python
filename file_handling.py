#getting input in file named num_con.txt and after running the program we'll get the number and equivalent english words in same file
...
def main():
    file=open("num_con.txt","r+")
    num=file.read()

    final=(num2word(int(num)))
    print(final)
    file.write("\n"+final)
    file.close()
